...
public class MatchStatsMapper {
    ...
    public MatchStatsResponseDTO entityListToResponseDto(List<MatchStats> matchStatsList, Match match) {
       ...
       // matchStatsMatchDTO.setDate(match.getScheduled_at());
        ...
        teamOneDto.setScore(match.getResults().stream().filter(score -> score.getTeamId().equals(match.getOpponents().get(0).getId())).findFirst().get().getScore());
      //  matchStatsMatchDTO.setTeamOne(teamOneDto);
        ...
        teamTwoDto.setScore(match.getResults().stream().filter(score -> score.getTeamId().equals(match.getOpponents().get(1).getId())).findFirst().get().getScore());
